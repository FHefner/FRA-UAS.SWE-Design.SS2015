...
public class Floor {
	...
	public void toggleLight() {
		if (arrivalLightOn) {
			...
			MainWindow.getTravelListModel().addElement("The arrival light was switched OFF at floor " + level);
		}
		else {
			arrivalLightOn = true;
			System.out.println("The arrival light was switched ON at floor " + level);
			MainWindow.getTravelListModel().addElement("The arrival light was switched ON at floor " + level);
		}
	}
	...
	public void toggleDoor() {
		if (myDoor.isOpen()) {
			...
			MainWindow.getTravelListModel().addElement("Door was closed on floor " + level);
		}
		else {
			myDoor.setOpen(true);
			System.out.println("Door was opened on floor " + level);
			MainWindow.getTravelListModel().addElement("Door was opened on floor " + level);
		}
	}
